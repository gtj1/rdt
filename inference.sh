...
python -m scripts.aubo_inference \
    --pretrained_model_name_or_path="checkpoints/rdt-finetune-1b/checkpoint-200" \
    --lang_embeddings_path="outs/lang_embeddings/move_bottle.pt" \
    --ctrl_freq=5    # your control frequency